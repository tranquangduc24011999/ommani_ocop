        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#buzz" role="tab" data-toggle="tab">Điểm đã chấm</a>
                    </li>
                </ul>
                            ...
                            <div class="row" style="margin-top: 26px;">
                                <div class="col-lg-8">
                                    <div class="col-md-12"
                                        ...
                                        <span class="textOcop" id="productcode"><span class="productTi">Người chấm: {{$user->name}}</span></span>
                                        @if(isset($totalMark))
                                        <br/>
                                                ...
                                                <div id="signature" class="col-md-12 " style="margin-top: 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div align="right" class="col-4" style="margin-left: calc(100vw - 300px);margin-top: -20px;text-align:center;">
                                                            ...
                                                            <br/>
                                                            <br/>
                                                            <span style="display:inline-block;" class="productTi">{{$user->name}}</span><br/>
                                                            @if(isset($user->position))
                                                            <span style="display:inline-block;" class="productTi">{{$user->position}}</span><br/>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
