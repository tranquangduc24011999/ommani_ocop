            ...
            <div class="col-8" style="padding: 0;    display: flex;">
                ...
                <div class="mail-contnet" style="padding-top: 10px;width:100%">
                    ...
                    <div class="comment-footer m-b-10">
                        <span class="label label-{!!getColorStatus($product)!!}">{!!getProductStatus($product)!!}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="margin-top: 9%; background-color: #ffffff;">
                    ...
                    <div class="modal-body" style="padding: 21px;">
                        ...
                        <div class="row " style="overflow: auto;padding: 0px 16px;" id="ImgModal-info">
                        </div>
                        <div class="row " style="overflow: auto;padding: 0px 16px;" id="DocModal-info">
                        </div>
                        <div style="float: right;margin: 24px 0;">
                            <a href="#" class="btn btn-secondary" data-dismiss="modal" style="    width: 122px;
height: 40px;
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#profile" role="tab" data-toggle="tab">Hồ sơ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#buzz" role="tab" data-toggle="tab">Chấm điểm</a>
                    </li>
                </ul>
                    ...
                    <div role="tabpanel" class="tab-pane" id="buzz">
                        <div class="container-fluid">
                            <div class="row" style="margin-top: 26px;">
                                <div class="col-lg-8">
                                    <div class="col-md-12"
                                        style="text-align: left;border-bottom: 1px solid #dee2e6;padding-bottom: 24px;    background-color: white;text-align: center;">
                                        ...
                                        {{  !empty($product2->street) ? $product2->street.'-' : ''  }} {{$product2->ward}} - {{$product2->district}} - {{$product2->province}}</span><br/>
                                        <span class="textOcop" id="productcode"><span class="productTi">Người chấm: {{Auth::guard('web')->user()->name}}</span></span>
                                        @if(isset($totalMark))
                                        <br/>
                                        <span class="textOcop" id="productcode"><span class="productTi">Ngày chấm: {{$totalMark->updated_at->setTimezone('GMT+7')->format('d/m/Y')}}</span></span>
                                        @endif
                                        <div class="text-center" id="noteText"
                                            style="color:#039252!important;font-size:16px; display:none"> <span>Đang chấm</span>
                                    ...
                                    <div id="question" style="background-color: white;padding: 26px;">
                                        ...
                                        <div class="row" id="A">
                                            <div class="col-md-12" style="margin-top: 22px;margin-bottom: 22px; ">
                                                <span class="titileoCop">PHẦN A:
                                                    {!!Str::of($groupA[0][0]->groupName)->upper()!!}</span>
                                            </div>
                                            <br>
                                                    ...
                                                    <div>
                                                        <label for="productName">
                                                            <div style="display:flex">
                                                                ...
                                                                <span class="SubHeading"> {!! $items[0]->sectionName!!}
                                                                </span>
                                                            </div>
                                                        </label>
                                                        ...
                                                        <div
                                                            ...
                                                            <span>
                                                                <b>
                                                                    {!!$item->question!!}
                                                                    <a
                                                                        href="javascript:showHelp('{!!$item->questionId!!}')"><i
                                                                            class="mdi mdi-help-circle"></i></a>
                                                                </b>
                                                            </span>
                                                            <a class="iconrole alo2" href="#"
                                                                data-toggle="modal" style="display: none;" data-target="#comment"
                                                                onclick="openCommnent('{{$product->id}}','{{$item->questionId}}')">
                                                                <div class="divComment"> <img
                                                                        src="{{ asset('images/fi-xnsuxx-comment-square-solid.png') }}"
                                                                        style="margin-left: 10px;margin-top: 6px;"
                                                                        width="16px" height="16px">
                                                                    <div class="infoNote" id="infoNote{{$item->questionId}}"
                                                                        style="display:{{$item->count_note > 0 ? '' : 'none' }}">{{$item->count_note}}</div>
                                                                </div>
                                                            </a>
                                                            <a class="iconroles" href="#" data-toggle="modal" style="display: none;"
                                                                data-target="#exampleModalOcop"
                                                                onclick="checkInfoOcop('{{$product->id}}','{{$item->questionId}}')">
                                                                <div class="divocop"><img
                                                                        src="{{ asset('images/blacsk.png') }}"
                                                                        class="Black"
                                                                        style="margin-left: 10px;margin-top: 6px;">
                                                                </div>
                                                            </a>
                                                            ...
                                                            <div id="AQuestion-{!!$questionIndexA!!}">
                                                                ...
                                                                <div class="ml-3" style="position: relative;">
                                                                    <label><b>{!! $item2->question!!} <a
                                                                        ...
                                                                        data-toggle="modal" style="display: none;" data-target="#comment"
                                                                        onclick="openCommnent({{$product->id}}','{{$item2->questionId}})">
                                                                        <div class="divComment"> <img
                                                                                src="{{ asset('images/fi-xnsuxx-comment-square-solid.png') }}"
                                                                                style="margin-left: 10px;margin-top: 6px;"
                                                                        ...
                                                                        data-target="#exampleModalOcop"
                                                                        onclick="checkInfoOcop('{{$product->id}}','{{$item2->questionId}}')">
                                                                        <div class="divocop"><img
                                                                                src="{{ asset('images/blacsk.png') }}"
                                                                                class="Black"
                                                                                style="margin-left: 10px;margin-top: 6px">
                                                                                <div class="infoNotelv2" id="infoNote{{$item2->questionId}}"
                                                                                    style="display:{{$item2->count_note > 0 ? '' : 'none' }}">{{$item2->count_note}}</div>
                                                                        </div>
                                                                    </a>
                                                                    ...
                                                                    <div style="display: flex;">
                                                                        ...
                                                                        <span
                                                                            style="font-size: 13px;float: right;position: absolute;right: 4px;font-style: italic;font-weight: 600!important;color: #039252!important;">{!!
                                                                            $answer->point!!}
                                                                            điểm</span>
                                                                    </div>
                                                                    @endforeach
                                                                ...
                                                                <div style="display: flex;">
                                                                    ...
                                                                    data-answer-text="{!! $answer->content!!}">
                                                                    <label
                                                                        style="width: 80%;color:#212529; font-weight:400;font-style: normal"
                                                                        name="lbl_A_Section{!!$index!!}_Question{!!$questionIndexA!!}"
                                        ...
                                        <div class="row" id="B">
                                            <div class="col-md-12" style="margin-top: 22px;margin-bottom: 22px; ">
                                                <span class="titileoCop">PHẦN B:
                                                    {!!Str::of($groupB[0][0]->groupName)->upper()!!}</span>
                                            </div>
                                            <br>
                                                            ...
                                                            <div id="BQuestion-{!!$questionIndexB!!}">
                                                                ...
                                                                <div class="ml-3" style="position: relative;">
                                                                    ...
                                                                    <div style="display: flex;">
                                                                        ...
                                                                        data-question-id="{!!$answer->questionId!!}"
                                                                        data-answer-id="{!!$answer->answerId!!}"
                                                                        data-answer-text="Có các tạp chất, chấp nhận
                                                                        được">
                                                                        <label style="width: 80%;color:#212529;"
                                                                ...
                                                                <div style="display: flex;">
                                                                    ...
                                                                    data-question-id="{!!$answer->questionId!!}"
                                                                    data-answer-id="{!!$answer->answerId!!}"
                                                                    data-answer-text="Có các tạp chất, chấp nhận được">
                                                                    <label style="width: 80%;color:#212529;"
                                                                        name="lbl_B_Section{!!$index!!}_Question{!!$questionIndexB!!}"
                                        ...
                                        <div class="row" id="C">
                                            <div class="col-md-12" style="margin-top: 22px;margin-bottom: 22px; ">
                                                <span class="titileoCop">PHẦN C:
                                                    {!!Str::of($groupC[0][0]->groupName)->upper()!!}</span>
                                            </div>
                                            <br>
                                ...
                                <div class="col-lg-4" id="reponsivePc">
                                    <div class="bodycontent" id="scrollPc"
                                        style="background-color: white; padding: 26px 5px 50px; position: relative; width: 100%; top: 0px;">
                                        <div id="bootommIdeaPc" style="">
                                            <div class="row">
                                                <div class="col-md-12" style="margin-top: 22px;">
                                                    <div style="margin-bottom: 16px;">
                                                        <span class="Part">Phần A</span> <span class="Part"
                                                            style="float: right;">/{!!$totalA!!}đ</span><span
                                                            id="A-totalPoint" class="Part"
                                                    ...
                                                    <div style="margin-bottom: 16px;    width: 100%;">
                                                        ...
                                                        <span id="totalPoint" class="Part"
                                                            style="float: right;font-size: 20px;color: #049252;font-weight: bold!important;">0</span><br>
                                                    </div>
                                                    <div style="margin-bottom: 16px;    width: 100%;">
                                                        <span class="Part">Xếp hạng</span> <span id="rankStar"
                                                            class="Part"
                                                ...
                                                <div class="col-md-12" style="margin-top: 20px;">
                                                    ...
                                                    --}}
                                                    <button id="saveresult" type="submit"
                                                        onclick="saveResult('PROCESSING',true,{{Auth::guard('web')->user()->id}})"
                                                        style="background-color: #039252; color: #ffff;visibility: hidden;"
                                                        value="Đăng nhập" class="btn btn-block">Lưu</button>
                                                </div>
                                                <div class="col-md-12" style="margin-top: 12px;">
                                                        <button id="completeEvaluate" onclick="printDiv('buzz','Title')"
                                                            class="evaluateStatus text-white btn mr-2"
                                                            style="flex: 1; background-color: #039252; width:100%;visibility: hidden;" data-toggle="tooltip"
                                                            data-placement="top">In</button>
                                                </div>
                                                <div id="signature" class="col-md-12 " style="margin-top: 10px;">
                                                    <div class="row">
                                                        <div align="left" class="col-8" style="margin-top: 60px;">
                                                            <span>Ý kiến của người đánh giá</span>
                                                        </div>
                                                        <div align="right" class="col-4" style="margin-left: calc(100vw - 300px);margin-top: -20px;text-align:center;">
                                                            <span>.......Ngày......Tháng......Năm 20......</span><br/>
                                                            <span style="display:inline-block;">NGƯỜI ĐÁNH GIÁ</span><br/>
                                                            <span style="display:inline-block;">(Ký và ghi rõ họ tên)</span><br/>
                                                            <br/>
                                                            <br/>
                                                            <br/>
                                                            <br/>
                                                            ...
                                                            <br/>
                                                            <br/>
                                                            <span style="display:inline-block;" class="productTi">{{Auth::guard('web')->user()->name}}</span><br/>
                                                            @if(isset(Auth::guard('web')->user()->position))
                                                            <span style="display:inline-block;" class="productTi">{{Auth::guard('web')->user()->position}}</span><br/>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-4" id="reponsiveMobile" style="display:none">
                            ...
                            <div class="modal fade" id="comment" tabindex="-1" role="dialog" style="display:none">
                                <div class="modal-dialog" role="document">
                            ...
                            <div class="modal fade bs-example-modal-lg" id="exampleModalOcop" tabindex="-1"
                                role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display:none">
                                <div class="modal-dialog " role="document">
                                    <div class="modal-content">
...
function printDiv(divId,
 ...
 let mywindow = window.open('', 'PRINT', 'width=1800,top=100,left=0');
var parent = document.getElementById(divId);
var element = document.getElementById("completeEvaluate");
//element.parentNode.removeChild(element);

var element2 = document.getElementById("saveresult");
//element2.parentNode.removeChild(element2);
//parent.removeChild(element);

 mywindow.document.write(`<html><head><title></title>`);
 mywindow.document.write('</head><body >');
 mywindow.document.write(parent.innerHTML);
