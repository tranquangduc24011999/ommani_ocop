                        ...
                        <div class="row">
                            ...
                            <div class="mt-3">
                                        ...
                                        <div class="form-material row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="productType" name="productType" class="form-control">
                                                    ...
                                                    <option value="{!! $item->id !!}" {{ ($product->product_type==$item->id) ? '
                                            ...
                                            <div class="form-group col-md-6">
                                                <b class="mt-3">MÃ SẢN PHẨM</b>
                                                  <div name="form-control form-control-line" style="width: 100%; height: 38px; background-color: #f3f3f3 !important; display: flex; align-items: center; padding: 0 12px; font-size: 14px; color: #495057; border-radius: 0.6rem;">
                                                       <span id="provinceCode">{!!$provinceCode!!}-</span>
                                                       <span id="districtCode">{!!$districtCode!!}-</span>
                                                       <input type="text" id="productCount" name="productCount" value="{!! old('name',isset($count) ? $count : null) !!}" style="width: 35px; height: 20px; border-top: none; border-right: none; border-left: none;  border-bottom: 1px solid #000; border-radius: 0 !important; background: transparent !important;" placeholder=" ">
                                ...
                                <div class="text-center container mt-3 mb-3">
                                    <button id="complete3Steps" onclick="updateProduct()"
                                        class="btn btn-lg btn-block" style="background-color: #039252; color: white;">
                                        Cập nhật
                                    </button>
                                    <button id="EditStep" onclick="updateProduct()" class="btn btn-lg btn-block"
                                        style="background-color: #039252; color: white;display: none">
                                        Lưu
                                    </button>
                                </div>
                                <!-- </div> -->
