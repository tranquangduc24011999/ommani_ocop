...
<title>OCOP | Phiếu đăng ký</title>
<!-- This page CSS -->
<!-- chartist CSS -->
...
<![endif]-->
    ...
    <link href="{{ asset('css/multiStepForm.css') }}" rel="stylesheet"> <!-- style cho form nhiều bước -->
    <link href="{{ asset('css/rateStar.css') }}" rel="stylesheet"> <!-- style cho rate sao -->
    ...
    <style>
        ...
        .select2-container--default .select2-results__option--highlighted[aria-selected] {
            background-color: #82d5fa !important;
        }
...
<!--Menu topbar -->
<script src="{{ asset('js/topbar-head.js') }}"></script>
<script>
...
{{-- <script src="{{ asset('js/checkLogin.js') }}" type="text/javascript"></script> --}}
<script>
	let listNotif = []
  $(document).ready(() => {
    //getNotify()
...
<style>
  .topbar .top-navbar .mailbox {
    ...
    <script src="{{ asset('js/multiStepForm.js') }}"></script> <!-- file điều khiển các bước trong form -->
    <script src="{{ asset('js/bootstrap-material-datetimepicker.js') }}"></script>
    <script src="{{ asset('js/createproduct.js?v=2') }}"></script>
    {{--<script src="{{ asset('js/wvSubmitMemberForm.js') }}"></script> --}}
    <script src="{{ asset('js/lodash.js') }}"></script>
    <!-- <script src="./javascripts/wvSubmitProductForm.js"></script> -->
    <!-- end - This is for export functionality only -->


<input type="file" class="dz-hidden-input" accept="image/jpeg,image/png,image/gif,image/jpg" style="visibility: hidden; position: absolute; top: 0px; left: 0px; height: 0px; width: 0px;"></body></html>