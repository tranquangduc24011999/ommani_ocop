                        ...
                        <div class="rowclickImg" id="upload">
                            <form method="post" action="#" enctype="multipart/form-data" id="DropzoneNew"
                                ...
                                <div id="quote" style="margin-left: 2px;    margin-top: 40px;">
                                    ...
                                    <select id="selectedqa" multiple="multiple" tabindex="-1"
                    ...
                    <div class="modal-body" style="padding: 0 24px;">
                        ...
                        <div id="quote" style="margin-left: 2px;    margin-top: 40px;">
                            ...
                            <a class="test" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="Chủ động lựa chọn tiêu chí trong mục 'Viện dẫn' sẽ tạo điều kiện thuận lợi cho doanh nghiệp đánh giá được các minh chứng đã nộp trước khi sản phẩm được xếp hạng."><i
                                    class="fa fa-info-circle" style="font-size: 16px;color: #03a9f3;"></i></a>
                            <select id="selected2qa" multiple="multiple"
...
background-color: #eff0f1;" placeholder="Vd: Tôi không thể tải ảnh" id="idText"></textarea>
                                    ...
                                    <div class="card-body" id="Obligatory">
                                        ...
                                        <div class="ectangle">
                                            ...
                                            <div style="padding-top: 24px;padding-bottom: 10px;padding-left: 12px;padding-right: 12px;display: flex;justify-content: center;">
                                                <div class="Rectangle-Copy" onclick="openQuestionModal({!! $item->id !!},{!! $product->id !!},'{!! $item->title!!}')">
                                        ...
                                        <div class="ectangle" style="position:relative">
                                            ...
                                            <div
                                                ...
                                                <div class="Rectangle-Copy" onclick="openQuestionModal('{!! $item->id !!}','{!! $product->id !!}','{!! $item->title!!}')">
                                                    ...
                                                    <a class="uploadButton" href="javascript:openQuestionModal('{!! $item->id !!}','{!! $product->id !!}','{!! $item->title!!}')"
                                                        data-target="#step1"
                                                        >
                                                        <img src="{{ asset('images/primary.png') }}"
                                                            srcset="{{ asset('images/primary2x.png') }} 2x, {{ asset('images/primary3x.png') }} 3x"
                                                            class="Primary" style="margin-top: 13px;">
                                                    </a>
                                                </div>
                                                <div class="re-Copy" style="margin-right: 8px;" onclick="clickquestion('{!! $item->id!!}')">
                                                    <a href="" data-toggle="modal" data-target="#step3"
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="buzz">
                        <div class="container-fluid p-0">
                            <div class="row" style="margin-top: 26px;">
                                <div class="col-lg-8">
                                    <div class="col-md-12"
                                        style="border-bottom: 1px solid #dee2e6;padding: 24px 0;background-color: white; text-align: center;">
                                            ...
                                            <div class="col-md-12" id="A-content" style="padding: 0;margin: 0;">
                                                ...
                                                <form class="form-material" id="A_Section{!!$index!!}">
                                                    <div>
                                                        ...
                                                        <?php $questionIndexA += 1 ?>
                                                        <div
                                                            style="width:100%;position: relative;display: inline-table;margin:15px 0;">

                                                            <span name="A_Section{!!$index!!}_Question{!!$questionIndexA!!}"
                                                                  value="{!! $index+1 !!}">
                                                                <b>
                                                                    {!!$item->question!!}
                                                                    <a
                                                            ...
                                                            <a class="iconroles" href="#" data-toggle="modal"
                                                            ...
                                                            <div id="AQuestion-{!!$questionIndexA!!}">
                                                                ...
                                                                <div class="ml-3" style="position: relative;">
                                                                    ...
                                                                    <div style="display: flex;margin-top: 5px; align-items: center">
                                                                        ...
                                                                        <label style="width: 80%;color:#212529;margin-bottom: 0"
                                                                ...
                                                                <div style="display: flex;margin-top: 5px;align-items: center;">
                                                                    ...
                                                                    data-answer-text="{!! $answer->content!!}">
                                                                    <label
                                                                        style="width: 80%;color:#212529; font-weight:400;font-style: normal;margin-bottom:0"
                                                                        name="lbl_A_Section{!!$index!!}_Question{!!$questionIndexA!!}"
                                                                ...
                                                                @if(isset($answer->note_after))
                                                                    <label>{!!$answer->note_after!!}</label>
                                                                @else
                                                                @endif
                                                                @endforeach
                                                                @endif
                                                ...
                                                <form class="form-material" id="B_Section{!!$index!!}">
                                                    <div>
                                                        ...
                                                        <div
                                                            ...
                                                            <span name="B_Section{!!$index!!}_Question{!!$questionIndexB!!}"
                                                                  value="{!! $index+1 !!}">
                                                                <b>
                                                                    {!!$item->question!!}
                                                                    <a
                                                            ...
                                                            <a class="iconrole alo2" href="#"
                                                                ...
                                                                <div class="divComment"> <img
                                                                        ...
                                                                        style="margin-left: 10px;margin-top: 6px;"
                                                                        width="16px" height="16px">
                                                                    <div class="infoNote" id="infoNote1.detail[0]"
                                                                        style="display:none"></div>
                                                                </div>
                                                            </a>
                                                            <a class="iconroles" href="#" data-toggle="modal"
                                                ...
                                                <form class="form-material" id="C_Section{!!$index!!}">
                                                    <div>
                                                        ...
                                                        <div
                                                            ...
                                                            <span name="C_Section{!!$index!!}_Question{!!$questionIndexC!!}"
                                                                  value="{!! $index+1 !!}">
                                                                <b>
                                                                    {!!$item->question!!}
                                                                    <a
                                        ...
                                        <div id="bootommIdeaPc" style="">
                                            <div class="row">
                                                <div class="col-md-12" style="margin-top: 22px;">
                                                    ...
                                                    <div style="margin-bottom: 16px;    width: 100%;">
                                                        <span class="Part">Xếp hạng dự kiến</span> <span id="rankStar"
                                                            class="Part"
                                                ...
                                                <div class="col-md-12" style="margin-top: 20px;">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        style="background-color: #039252; color: #ffff;"
        ...
        <!-- ============================================================== -->
        <!-- .right-sidebar -->
        <div class="right-sidebar ps ps--theme_default" data-ps-id="3366862c-4f2d-4916-e670-818472e64ddc">
...
<script type="text/javascript">
    ...
    var lv1 = {!! json_encode($level1) !!};
    var lv2 = {!! json_encode($level2) !!};
    var lv3 = {!! json_encode($level3) !!};
    var lv4 = {!! json_encode($level4) !!};
    var lv5 = {!! json_encode($level5) !!};
</script>
@endsection()
